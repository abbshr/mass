...
module.exports = operators => {
  // require("../operators/preload/window.calc")(operators)
  ...
  class TumblingTimeWindowCalculator extends operators.WindowCalculator {
     ...
     */
    runEvictChecker() {
      this.evictChecker = setTimeout(() => {
        this.checkWindowEvictable()
        this.runEvictChecker()
